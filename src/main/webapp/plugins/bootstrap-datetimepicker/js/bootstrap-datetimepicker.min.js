...
//          this.picker.find("tfoot th.today").text(d[this.language].today).toggle(this.todayBtn !== false);
    ...
    var b = {
        ...
        headTemplate: '<thead><tr><th class="prev"><i class="fa fa-chevron-left"/></th><th colspan="5" class="switch"></th><th class="next"><i class="fa fa-chevron-right"/></th></tr></thead>',
    ...
    c(document).on("focus.datetimepicker.data-api click.datetimepicker.data-api", '[data-provide="datetimepicker"]',
    function(h) {
        var g = c(this);
