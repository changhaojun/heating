        ...
        this.each(function (p, k) {
            ...
            var n = {
                ...
                grabItem: function (d) {
                    if (!(d.which != 1 || b(d.target).is(e.dragSelectorExclude))) {
                        ...
                        a.scroll.scrollY = window.setInterval(function () {
                            if (e.scrollContainer != window) b(e.scrollContainer).scrollTop(b(e.scrollContainer).scrollTop() + a.scroll.moveY); else {
                        ...
                        a.scroll.scrollX = window.setInterval(function () {
                            if (e.scrollContainer != window) b(e.scrollContainer).scrollLeft(b(e.scrollContainer).scrollLeft() + a.scroll.moveX); else {
                ...
                buildPositionTable: function () {
                    var d = this.draggedItem == null ? null : this.draggedItem.get(0), c = [];
                ...
                swapItems: function (d) {
                    ...
                    a.setPos(d.pageX, d.pageY);
                    for (var c = a.findPos(d.pageX, d.pageY), f = a,
                             h = 0; c == -1 && e.dragBetween && h < j.length; h++) {
                ...
                createDropTargets: function () {
                    e.dragBetween && b(j).each(function () {
                        ...
                        if (d.size() > 0 && c.size() > 0) c.remove(); else d.size() == 0 && c.size() == 0 && b(this.container).append(a.placeHolderItem.clone().removeAttr("data-placeHolder").attr("data-dropTarget", true))
                    })
                }
            };
            n.init();
